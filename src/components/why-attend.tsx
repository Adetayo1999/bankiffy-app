...
const WhyAttendCard: React.FC<{
  ...
  return (
    ...
    >
      <motion.h1
        className={clsx(
          "relative z-10 text-base md:text-lg lg:text-xl font-bold uppercase mb-6 md:mb-10",
      ...
      <div
        className={clsx(
          "relative z-10 flex",
          props.idx % 2 !== 0 && "justify-end",
        )}
      >
        <p
          className={clsx(
            "w-full sm:w-48 md:w-full lg:w-60 text-sm md:text-base lg:text-xl",
          )}
        >
          {props.description}
        </p>
