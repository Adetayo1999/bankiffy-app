...
export const PartnerWithUs = () => {
  ...
  return (
    <div className="text-white" ref={ref}>
      <motion.div
        className="mb-8 md:mb-14 flex flex-col md:flex-row justify-between items-start md:items-center gap-6"
      ...
      >
        ...
        <motion.div
          className="flex flex-col md:flex-row justify-between gap-6 md:gap-x-16 lg:gap-x-64"
          variants={containerVariants}
          initial="hidden"
          animate={isInView ? "visible" : "hidden"}
        >
          <motion.div className="shrink-0" variants={itemVariants}>
            <h1 className="text-xl md:text-2xl lg:text-[2.5rem] font-bold md:w-60">
              About <br /> Bankiffy
            </h1>
          </motion.div>
          <motion.div variants={itemVariants}>
            <h2 className="text-xl md:text-2xl lg:text-[2.5rem] font-bold mb-3 md:mb-6">
              Driving Financial inclusion
            </h2>
            <p className="text-sm md:text-base lg:text-xl">
              Our goal is drive financial inclusion across Africa through
              partnership, initiate program that empowers thought leaders to
